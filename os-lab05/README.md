Лабораторная работа №5. Разделяемая память.
...
1. В программе должны использоваться вызовы функций shm_open(), ftruncate(), close(), mmap(2), munmap(), shm_unlink().
